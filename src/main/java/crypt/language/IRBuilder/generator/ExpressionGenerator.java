...
import crypt.language.IRBuilder.generator.expression.LiteralExpressionGenerator;
...
public class ExpressionGenerator implements Expression.Visitor<Void>{
    ...
    public final LiteralExpressionGenerator literalExpressionGenerator = new LiteralExpressionGenerator(methodVisitor);
    ...
    public Void visitLiteralExpression(Expression.Literal expression) {
        literalExpressionGenerator.generate(expression);
        return null;
    }
