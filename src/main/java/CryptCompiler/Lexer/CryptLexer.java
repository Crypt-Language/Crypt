...
public class CryptLexer {
    ...
    private void scanToken() throws Exception {
        ...
        switch (c) {
            ...
            case '\t': newToken(TokenType.WHITESPACE); break;
            case '\r': newToken(TokenType.WHITESPACE); break;
            ...
            case '\n': {
                ...
                if(indentLevel <= currentIndent) EncoderCLI.error(line, "Bad indent level.");
                ...
                //else if(indentLevel < currentIndent) newToken(TokenType.DEDENT);
